...
Original file is located at
    https://colab.research.google.com/drive/14v0nwY1zuOsiJr4qqsljhzLXgyvOTUBP
...
def preprocess_sentence(sentence):
  ...
  sentence = re.sub(r"http[s]?://(?:[a-zA-Z]|[0-9]|[$-_@.&+]|[!*\(\),]|(?:%[0-9a-fA-F][0-9a-fA-F]))+", "hyperlink", sentence)
  sentence = re.sub(r"[-()\"#/@;:<>{}+=~|.?,]", "", sentence)

  return sentence

def load_conversations_OpenDomain():
  print("Text preprocessing")
  df = pd.read_csv('OpenDomain.csv')
  df['QuestionText'] = df['QuestionText'].apply(lambda x: preprocess_sentence(str(x)))
  df['AnswerText'] = df['AnswerText'].apply(lambda x: preprocess_sentence(str(x)))
  inputs, outputs = df['QuestionText'].tolist(), df['AnswerText'].tolist()
  return inputs, outputs

def load_conversations_ClosedDomain():
  print("Text preprocessing")
...
class MultiHeadAttention(tf.keras.layers.Layer):
  ...
  def call(self,inputs):
    ...
    #use scaled dot-product attention function
...
def main():
    ...
    model.save_weights('openDomain_weights.h5')
    print("\nModel weights saved!")
